            ...
            emp.projects.forEach((proj: any) => {
              proj.billingDetails.forEach((detail:any) => {
                exportData.push({
                  ...
                  'Role': detail.sg_position_role,
                  'Billing Status': detail.billing_status,
                  'Billing Method': detail.sg_billing_method,
                  'Total Leave': detail.total_leave,
                  'GCW Hrs.': detail.GCW_hrs,
                  'Missing TimeSheet Hrs.': detail.missing_timeSheet,
